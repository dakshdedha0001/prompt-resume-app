      ...
      <main className="max-w-[800px] mx-auto px-5 py-12 flex-1">
        ...
        <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>
              We use your information to fulfill digital file downloads, manage account access on your dashboard, provide customer support via Instagram DM (@prompt_resume) or email, and send order confirmation updates.
            </p>
          </section>
